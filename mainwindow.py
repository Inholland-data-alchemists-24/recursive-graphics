...
def initialize_gui() -> tk.Tk:
    ...
    slider_var8 = tk.IntVar()    # CONFIG: Define parameters of each of the sliders
    each_slider = {"x_padding": 0, "y_padding": 7, "minimum_width": 150}  # CONFIG
    slider_data = [
        ("Trunk's Length", 10, 200, 1, "slider_var1"),
        ("Branch Splits", 2, 7, 1, "slider_var2"),
        ("Length Ratio", 0.2, 1.2, 0.01, "slider_var3"),
        ("Angle Between Branches", 0, 180, 1, "slider_var4"),
        ("Iterations", 1, 9, 1, "slider_var5"),
        ("Angle Offset", -45, 45, 1, "slider_var6"),
        ("Trunk's Color", 0, 360, 1, "slider_var7"),
        ("Leaf Color", 0, 360, 1, "slider_var8")
    ]  # CONFIG
    ...
    def printslider():
        print(slider_var1.get())

    # Create sliders with the initial layout
    sliders = create_sliders(
        slider_frame, slider_data, optimal_num_of_slider_columns, each_slider["x_padding"], each_slider["y_padding"], "printslider"
    )
